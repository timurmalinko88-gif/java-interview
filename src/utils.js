...
export function setDifficultyChipInactive(el, diff) {
    ...
    if (diff === 'Junior') el.classList.add('bg-success-500/10', 'text-success-600', 'dark:text-success-400');
...
export function setDifficultyChipActive(el) {
    el.classList.remove('bg-success-500/10', 'bg-brand-500/10', 'bg-purple-500/10', 'text-success-600', 'text-brand-600', 'text-purple-600', 'dark:text-success-400', 'dark:text-brand-400', 'dark:text-purple-400');
