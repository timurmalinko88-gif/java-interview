...
1. `i = 0 (73)`: Stack empty $\rightarrow$ push index `0`. Stack: `[0]`
2. `i = 1 (74)`: `74 > 73` (top index 0). Pop `0` $\rightarrow$ `ans[0] = 1 - 0 = 1`. Push `1`. Stack: `[1]`
3. `i = 2 (75)`: `75 > 74` (top index 1). Pop `1` $\rightarrow$ `ans[1] = 2 - 1 = 1`. Push `2`. Stack: `[2]`
4. `i = 3 (71)`: `71 < 75`. Push `3`. Stack: `[2, 3]`
5. `i = 4 (69)`: `69 < 71`. Push `4`. Stack: `[2, 3, 4]`
6. `i = 5 (72)`:
   - `72 > 69` (top index 4) $\rightarrow$ pop `4`, `ans[4] = 5 - 4 = 1`.
   - `72 > 71` (top index 3) $\rightarrow$ pop `3`, `ans[3] = 5 - 3 = 2`.
   - `72 < 75` (top index 2) $\rightarrow$ stop popping. Push `5`. Stack: `[2, 5]`
